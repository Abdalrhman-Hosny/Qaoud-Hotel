...
<head>
    ...
    <title>Kaoud Hotel - About Us</title>
    <!-- Bootstrap CSS link -->
...
<body class="bg-light">
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
                ...
                <p class="text-secondary">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Amet, blanditiis? Aliquid maiores dolorum eligendi officiis. Quam!
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Amet, blanditiis? Aliquid maiores dolorum eligendi officiis. Quam!
                </p>
            </div>
            <div class="col-lg-5 col-md-5 mb-4 order-lg-2 order-md-1 order-1">
                <img src="images/about/about.jpg" class="w-100 rounded-3">
            </div>
        </div>
    </div>
    ...
    <div class="container px-4">
        <div class="swiper swiper-container">
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white text-center overflow-hidden rounded-4">
                    <img src="images/about/team.jpg" class="w-100" style="height: 320px;">
                    <h5 class="mt-2">Hosny</h5>
                </div>
                <div class="swiper-slide bg-white text-center overflow-hidden rounded-4">
                    <img src="images/about/team.jpg" class="w-100" style="height: 320px;">
                    <h5 class="mt-2">Hosny</h5>
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Design and Developer By Abdalrhman Hosny</h6>
